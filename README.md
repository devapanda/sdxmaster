...
This is Governance Dapp for SdxChain. Full-Node can apply to become a candidate for masternode. Coin Holder can vote for candidates to become masternodes. 
...
```
Note: before deploying to sdxchain testnet, make sure you have SDX in the wallet. If not, get free at [https://faucet.swapdex.net](https://faucet.testnet.swapdex.net)
